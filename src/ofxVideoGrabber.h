...
#define OFX_VID_GRABBER_TYPE ofxAVFoundationGrabber
...
class ofxVideoGrabber : public ofBaseVideoGrabber,public ofBaseVideoDraws{
	...
	private:
		...
		bool bUseTexture;
		std::shared_ptr<OFX_VID_GRABBER_TYPE> grabber  = nullptr;
		int requestedDeviceID;
    std::string requestedUniqueID = "";
